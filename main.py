...
def FACE_RECOGNITION():
	...
	try:
		result = face_recognition.compare_faces(face_encodings, unknown_face, tolerance = 0.6)
	except:
...
def capture_image(image_name):
	...
	sleep(3)
	camera.capture("image/" + image_name + ".jpg", resize=(240, 240))
	camera.stop_preview()
	camera.close()
	return 0
